...
class ClipLoss(nn.Module):
    ...
    def forward(self, eeg_features, image_features, logit_scale):
        device = eeg_features.device

        logits_per_eeg = logit_scale * eeg_features @ image_features.T
        logits_per_image = logit_scale * image_features @ eeg_features.T
        ...
        return eeg_loss, image_loss, logits_per_eeg
